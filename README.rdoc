...
M&C is a Redmine Plugin used as a chart tool to monitoring issues' project.  This was updated to support redmine 3.2.x from this original plugin here https://www.redmine.org/plugins/monitoring-controlling
...
* https://www.redmine.org/plugins/monitoring-controlling
